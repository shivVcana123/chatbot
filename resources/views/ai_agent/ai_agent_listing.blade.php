                                ...
                                <tr>
                                    <td class="first-td set-fonttable">
                                        <div class="d-flex align-items-center">
                                            <div class="set-boat-heading Ai-nname">
                                                <img src=".public/assets/images/vgbot.png" alt="Avatar" class="" width="40" height="40">
                                    ...
                                    <td>
                                        <div class="dropdown set-menu-btn d-inline-flex ">
                                            ...
                                            <img class="file-img" src="{{asset('public/assets/images/boat/file.png')}}">
                                            <button class="btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">

                                                <i class="fa-solid fa-ellipsis-vertical" style="color: #8b8b8b;"></i>
                                            </button>
                                            <ul class="dropdown-menu">
                                                <li class="border-bottom"><a class="dropdown-item" href="{{route('addagentform',$details->id)}}">Edit <span><img src="{{asset('public/assets/images/editicon.png')}}"></span></li></a>
